...
def model_training_bootstrap(model_type, segmentation_ratio, bootstrap_parameters):
    ...
    bootstrap_X = resample(X, n_samples=num_bootstraps, replace=True, random_state=None)
    bootstrap_Y = resample(Y, n_samples=num_bootstraps, replace=True, random_state=None)
